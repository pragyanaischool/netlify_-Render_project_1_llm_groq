...
export default function App() {
  ...
  async function sendQuestion() {
    ...
    setChatHistory((prev) => [...prev, { sender: "user", message: question, timestamp: new Date() }]);
    ...
    try {
      ...
      setChatHistory((prev) => [...prev, { sender: "bot", message: data.answer || "No response", timestamp: new Date() }]);
    } catch {
      setChatHistory((prev) => [...prev, { sender: "bot", message: "Error contacting server", timestamp: new Date() }]);
    }
    ...
    <div style={styles.container}>
      ...
      <footer style={styles.footer}>
        <input
          ...
          disabled={loading}
        />
        <button onClick={sendQuestion} disabled={loading || !question.trim()} style={styles.button}>
